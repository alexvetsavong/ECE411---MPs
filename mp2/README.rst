...
generated immediate arithmetic, register-register instructions.
...
To create the simulation binary, go to your ``hvl/`` directory and run
    ...
    :code:`$ vcs -sverilog -top mp2_tb top.sv`
...
To compile the code for use with waveform viewer, run
    ...
    :code:`$ vcs -sverilog -top mp2_tb -debug_access+r top.sv`
...
Additionally, you can have VCS output linting information with
    ...
    :code:`$ vcs -sverilog +lint=all -top mp2_tb top.sv`
